...
//   sweet alert pop up 
document.getElementById("NABKISAN").addEventListener("click", function () {
  Swal.fire({
    title: 'NABKISAN FINANCE LIMITED',
    html: `
      <div class="popup-body text-start">
        <p><strong>Website portal address:</strong> <a href="https://www.nabkisan.org" target="_blank">www.nabkisan.org</a></p>

        <p>NABKISAN Finance Limited (NKFL) (formerly “Agri Development Finance (Tamil Nadu) Limited”) was incorporated under the Companies Act, 1956 on <strong>14.02.1997</strong>. NKFL is a subsidiary of the National Bank for Agriculture and Rural Development (NABARD) with equity participation from NABARD, Govt. of Tamil Nadu, Indian Bank, Indian Overseas Bank, Tamilnad Mercantile Bank, Canara Bank, ICICI Bank, Federal Bank, Lakshmi Vilas Bank, and a few Corporates / Individuals.</p>

        <p>The company is notified as a <strong>Non-Banking Finance Company (NBFC)</strong> by RBI. The main objective of the company is to provide credit for promotion, expansion, and commercialization of enterprises in agriculture, allied, and rural non-farm activities.</p>

        <p>NKFL supports livelihood and income-generating activities by extending credit to Panchayat Level Federations, Trusts, Societies, and Section 25 companies / MFIs for on-lending to its member SHGs / JLGs. NABKISAN has also devised new financial products for <strong>Farmers’ Producers’ Organisations (FPOs)</strong> and has emerged as the biggest lender in the FPO ecosystem, having sanctioned more than 1800 FPO loans (as on Dec-2022).</p>

        <p>NABKISAN presently operates in <strong>21 states and 2 UTs</strong>, namely: Andhra Pradesh, Assam, Bihar, Chhattisgarh, Delhi, Gujarat, Haryana, Himachal Pradesh, Jharkhand, Karnataka, Kerala, Maharashtra, Madhya Pradesh, Odisha, Punjab, Rajasthan, Tamil Nadu, Telangana, Uttar Pradesh, Uttarakhand, West Bengal, J&K, and Puducherry.</p>

        <p>NABARD supports NABKISAN with refinance, credit guarantee, grant assistance, and strategic guidance — helping it become a leader in FPO lending.</p>

        <p>In its bulk lending segment, NABKISAN focuses on lending to NBFCs operating in rural areas, FPOs, agriculture/allied activities, value chain financing, and MSMEs engaged in income-generating activities.</p>

        <p>It partners with stakeholders including <strong>NCDEX, SEBI, NEML, NERL, NSTFDC</strong>, promoting institutions, and various State Governments to finance FPOs at concessional interest rates.</p>

        <hr>

        <h5><strong>Contact Information</strong></h5>
        <p><strong>Shri Prasad Rao</strong><br>
        Chief General Manager<br>
        Ground Floor, ‘D’ Wing<br>
        C-24, ‘G’ Block<br>
        Bandra-Kurla Complex, Bandra (East),<br>
        Mumbai - 400051<br>
        Tel no: 9514<br>
        Email: <a href="mailto:nabkisan@nabard.org">nabkisan@nabard.org</a></p>
      </div>
    `,
    ...
    preConfirm: () => {
      window.open("https://www.nabkisan.org", "_blank");
    }
  });
});
